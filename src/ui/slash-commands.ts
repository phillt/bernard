...
const CATALOGUE: readonly BuiltinSlashCommand[] = [
  ...
  { name: '/watchers', description: 'Show active watchers; cancel one' },
  { name: '/queue', description: 'Show turns waiting to run; drop one' },
  { name: '/sleep', description: 'Wake later and continue — /sleep 2h <what to do>' },
