...
| `BERNARD_MEMORY_CONSOLIDATION` | At session close, look over saved memories and suggest which have outlived their use (suggestions only — nothing changes unless you agree)                    | `true`            |
